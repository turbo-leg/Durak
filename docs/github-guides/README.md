...
All your GitHub learning resources are here! Pick the one that matches your needs.
...
- **Time:** 5 minutes
- **Contains:** Authentication, viewing issues, creating first branch
...
4. Do: [`TUTORIAL.md`](./TUTORIAL.md) (20 min - hands-on example)
...
4. Do: [`TUTORIAL.md`](./TUTORIAL.md) (20 min - hands-on)
...
4. Reference: [`GITHUB_CHEATSHEET.md`](./GITHUB_CHEATSHEET.md) (bookmark)

**Total Time:** ~45 minutes for mastery
...
- **Repository:** https://github.com/turbo-leg/Durak
- **Issues:** https://github.com/turbo-leg/Durak/issues
- **Pull Requests:** https://github.com/turbo-leg/Durak/pulls
...
4. GITHUB_CHEATSHEET.md        ← Reference
5. CREATE_ISSUE.md             ← Learn to create issues
6. TUTORIAL.md                 ← Hands-on practice
```
...
3. HOW_IT_WORKS.md             ← Complete understanding
```
...
1. **Right now:** Run `gh auth login` in your terminal
2. **In 5 min:** Read `QUICK_START.md`
3. **In 15 min:** Read `SIMPLE_EXPLANATION.md`
4. **In 30 min:** Create your first issue with `CREATE_ISSUE.md`
5. **In 50 min:** Follow `TUTORIAL.md` for hands-on practice

**You'll be ready to contribute in under an hour!** 🎉

---

## **💡 Tips**

- 📖 Read guides in order for best learning
- 🔍 Use Ctrl+F to search for specific commands
- 📌 Keep `GITHUB_CHEATSHEET.md` open as reference
- 🎯 Try each command yourself, don't just read
- 💬 If something is confusing, re-read `SIMPLE_EXPLANATION.md`
